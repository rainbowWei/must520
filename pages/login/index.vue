...
<div class="login">
  <div class="login-box">
    <el-form :model="loginForm" :rules="loginRule" ref="loginForm" label-position="center" 
             class="demo-ruleForm login-container">
      <h3 class="title">登录</h3>
      <div class="loginInfo">
        <el-form-item prop="account">
          <div class="name">  用户名：</div>
          <el-input type="text" v-model="loginForm.account" auto-complete="off" placeholder="请输入用户名" style="float:right"></el-input>
        </el-form-item>
        <el-form-item prop="checkPass">
          <div class="pass">密   码：</div>
          <el-input type="password" v-model="loginForm.checkPass" auto-complete="off" placeholder="请输入密码"  style="float:right"></el-input>
        </el-form-item>
    ...
    methods: {
      handleLogin(){
        ...
        this.$refs.loginForm.validate((valid) => {
          if (valid) {
            this.logining = true;
            let loginParams = {username: this.loginForm.account, password:Base64.encode( this.loginForm.checkPass)};
            getLogin(loginParams).then(result => {
              this.logining = false;
